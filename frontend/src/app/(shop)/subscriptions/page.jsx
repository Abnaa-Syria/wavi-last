...
import { MonitorPlay, ChevronLeft, ShoppingCart, Heart, GitCompare } from 'lucide-react';
...
const ProductCard = ({ id, title, category, price }) => {
  const finalImageUrl = title.includes('يوتيوب')
    ? 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=600&q=80'
    : title.includes('نتفليكس')
...
const subscriptionProducts = [
  { id: "1", title: "اشتراك فالكون برو (Falcon Pro) - 12 شهر", category: "مشاهدة", price: "150" },
  { id: "2", title: "اشتراك يوتيوب بريميوم - 6 أشهر", category: "منصات", price: "45" },
  { id: "5", title: "اشتراك نتفليكس - شاشة خاصة", category: "منصات", price: "25" },
];
